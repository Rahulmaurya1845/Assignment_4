...
const Divisions = React.lazy(() =>
    import("../../AdminComponents/academics/divisions/Divisions.js")
);
...
const MaleStudents = React.lazy(() =>
    import("../../AdminComponents/Profile/StudentsCountReport/Male_students")
);

const FemaleStudents = React.lazy(() =>
    import("../../AdminComponents/Profile/StudentsCountReport/Female_students")
);

const RegisteredStudents = React.lazy(() =>
    import("../../AdminComponents/Profile/StudentsCountReport/Registered_students")
);

const BdayStudents = React.lazy(() =>
    import("../../AdminComponents/Profile/StudentsCountReport/Bday_students")
);
...
const MaleStaff = React.lazy(() =>
    import("../../AdminComponents/Profile/StaffReports/MaleStaff")
);
const FemaleStaff = React.lazy(() =>
    import("../../AdminComponents/Profile/StaffReports/FemaleStaff")
);

const BdayStaff = React.lazy(() =>
    import("../../AdminComponents/Profile/StaffReports/BdayStaff")
);
...
const SetTransportFees = React.lazy(() =>
    import("../../AdminComponents/finance/set-transport-fees/SetTransportfees")
);
const TransportFees = React.lazy(() =>
    import("../../AdminComponents/finance/set-transport-fees/Transportfees")
);
...
const TeacherRequest = React.lazy(() =>
    import("./TeacherRequestForm")
);
const AdminApproval = React.lazy(() =>
    import("./AdminApprovalPanel")
);
const QuizAns = React.lazy(() =>
    import("./QuizAns")
);
const QuizQus = React.lazy(() =>
    import("./QuizQus")
);
const QuizDefault = React.lazy(() =>
    import("./QuizDefault")
);
...
//leaves
const AllLeaves = React.lazy(() =>
    import("../../AdminComponents/leaves/allLeaves")
)
// homework
const HomeworkForm = React.lazy(() =>
    import("../../AdminComponents/homework/HomeworkForm")
);
const AllHomework = React.lazy(() =>
    import("../../AdminComponents/homework/Allhomework")
);
const Gallery = React.lazy(() =>
    import("../../AdminComponents/gallery/gallery")
);
//message
const SmsCount = React.lazy(() =>
  import("../../AdminComponents/messages/SmsCount")
);
//quiz
...
const routes = [
    ...
    },
    {
        ...
        name: "AdminApprovalPanel",
        component: AdminApproval,
    },
    {
        path: "/defaultquiz",
        name: "Default Quiz",
        component: QuizDefault,
    },
    {
        path: "/createquiz",
        name: "Create Quiz",
    ...
    {
        path: "/finance/transport-fees",
        name: "Set Transport Fees",
        component: TransportFees,
    },
    {
        path: "/finance/set-transport-fees",
        name: "Set Transport Fees",
        component: SetTransportFees,
    },
    {
