    ...
    <div style={{ padding: "20px" }}>
        ...
        {notices.map((notice, index) => (
          <Grid item xs={12} sm={6} md={4} key={index}>
            <Card style={{ height: "100%" }}>
              ...
              <CardActions>
                <Button size="small" color="primary" onClick={() => handleOpenEdit(notice, true)}>
                  Edit
                </Button>
                <Button size="small" color="secondary" onClick={() => handleOpenEdit(notice, true)}>
                  Delete
                </Button>
              </CardActions>
            </Card>
      ...
      {isEdit && (
        <div className="notice-actions">
          {/* <IconButton onClick={() => handleOpenEdit(notices, true)}>
            <OpenInNewIcon />
          </IconButton> */}
          <Edit
            editData={editData}
