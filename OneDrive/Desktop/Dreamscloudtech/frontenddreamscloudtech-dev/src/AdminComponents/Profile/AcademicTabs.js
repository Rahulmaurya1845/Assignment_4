  ...
  return (
    <div>
      ...
      <div className="row">
        ...
        <div className="col-sm-6 col-md-4">
          <Card title="Classes" name={count?.classes} route="/academics/classes" />
        </div>
        <div className="col-sm-6 col-md-4">
          <Card title="Courses" name={count?.courses} route="/academics/courses" />
        </div>
        <div className="col-sm-6 col-md-4">
          <Card
            title="Class Terminal Report"
        ...
        {/* Centered Academic Transcripts card (same size as others) */}
        <div className="col-sm-6 col-md-4 offset-md-4">
          <Card title="Academic Transcripts" name="View" route="/reports/academic" />
        </div>
      </div>
