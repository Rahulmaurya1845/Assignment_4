...
function SummaryCard({ name, percentage, value }) {
  return (
    <div className="col-xs-12 col-sm-4 mb-3" style={{ backgroundColor: "#EEF7FF" }}>
      <Card className=" " style={{ backgroundColor: "#FFFFFF" }}>
        <div className="d-flex justify-content-between align-items-center heading bluee__btn p-2 text-light">
          <div>
            <h5>{name}</h5>
          </div>
