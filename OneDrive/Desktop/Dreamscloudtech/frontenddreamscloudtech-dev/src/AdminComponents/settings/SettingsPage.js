...
function SettingsPage() {
  ...
  return (
    <div >
      <div className="content__container d-flex flex-column align-items-center mb-0" style={{ backgroundColor: "#EEF7FF" }}>
      ...
      <div id="changepassword" style={{ backgroundColor: "#EEF7FF" }}>
