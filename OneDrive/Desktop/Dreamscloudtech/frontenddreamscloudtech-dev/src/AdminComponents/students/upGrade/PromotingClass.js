      ...
      <form className="content__container mb-3" style={{ backgroundColor: "#EEF7FF" }}>
        <div className="row mb-3 aligh-items-center">
          <div className="col-12 ">
            <h3 className="mb-4" style={{ fontSize: "20px" }}>Promoting Students to the next Class</h3>
          </div>
          ...
          <div className="col-xs-12 col-sm-12 d-flex justify-content-center mr-5 mb-2 mt-4">
            ...
            <button className="btn red__btn" style={{ width: "105px", fontWeight: "6px" }} onClick={handleCancelClass}>
              Cancel
            </button>
          </div>
        </div>
