...
function AddPrefect({
  ...
  return (
    <div className="" style={{ backgroundColor: "#EEF7FF" }}>
      <div className="-mb-1 content__container" style={{ backgroundColor: "#EEF7FF" }}>
        <h3 style={{ fontSize: "21px" }}>Search Student</h3>
        <div className="row">
        ...
        <div className="row">
          {students.length > 0 && (
            <div className="col-md-12">
              <label className="form-label mt-2 ml-1">OR Select Student's Class</label>
              <select
                style={{
                  backgroundColor: "#fffffd",
                  fontSize: "14px"
      ...
      <div className="content__container" style={{ backgroundColor: "#EEF7FF" }}>
        <h3 className="mb-4" style={{ fontSize: "20px" }}>Add Prefect</h3>
        <form action="">
