...
import Search from "../../shared/Search0";
    ...
    <div>
      <div className="d-flex justify-content-end mb-5">
        <button
          ...
          className="btn yellow__btn mr-3"
          to="/finance/banking"
        >
          Write Check
        </button>
        ...
        <button
          ...
          className="btn lred__btn mr-3"
          to="/finance/banking"
        >
          Withdraw Cash
        </button>
        <Link className="btn bblue__btn" to={`/finance/banking/edit/${id}`}>
          Edit Bank Details
        </Link>
      </div>
      <h3 style={{ marginTop: -80, marginLeft: "20px" }}>Banking Transcations</h3>
      <div className="mb-2 ml-4 mt-4 mb-4 " >
