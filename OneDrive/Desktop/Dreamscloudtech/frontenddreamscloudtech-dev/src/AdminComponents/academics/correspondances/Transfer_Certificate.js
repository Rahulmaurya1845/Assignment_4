...
function Transfer_Certificate({school, certificate}) {
        ...
        <div>
            ...
            <Paper id="section-to-print" className={classes.certificateContainer}>
                ...
                <Typography variant="body1" className={classes.body}>
                    This is to certify that {certificate.doc.salutation} <strong>{certificate.doc.name.name}</strong>, son of <strong>{certificate.doc.name.father_name}</strong> and <strong>{certificate.doc.name.mother_name}</strong>,
                    was admitted to <strong>{school?.fullName}</strong> on <strong>15 June 2020</strong> and studied up to <strong>Grade X</strong> in the session <strong>2024–2025</strong>.
                </Typography>
                <Typography variant="body1" className={classes.body}>
                    The date of birth as per school records is <strong>10 March 2010</strong>. The student’s conduct was <strong>EXCELLENT</strong> and no dues are pending.
                </Typography>
                <Typography variant="body1" className={classes.body}>
                    This certificate is issued on request for transfer purposes.
                </Typography>
