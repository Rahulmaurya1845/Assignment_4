...
function Bonafied_Certificate({school,student, certificate}) {
            ...
            <Paper id="section-to-print" className={classes.certificateContainer}>
                ...
                <div className={classes.header}>
                    ...
                    <Typography variant="body2" className="mt-2" gutterBottom>
                        {school?.address} | Email: {school?.email}
                    </Typography>
                ...
                <Typography variant="body1" className={classes.body}>
                    ...
                    is a bonafide student of <strong>{school?.fullName}</strong>. He/She has been studying in this institution since <strong>June 2020</strong> and is currently enrolled in <strong>Grade X</strong>
                    for the academic session <strong>2024–2025</strong>.
                </Typography>
                <Typography variant="body1" className={classes.body}>
                    The student has maintained a disciplined conduct and has actively participated in curricular and co-curricular activities during their time at the institution.
                </Typography>
                <Typography variant="body1" className={classes.body}>
