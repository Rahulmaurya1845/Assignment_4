...
function Character_Certificate({school, certificate}) {
    ...
    <div>
      ...
      <Paper id="section-to-print" className={classes.certificateContainer}>
        ...
        <Typography variant="body1" className={classes.body}>
          This is to certify that {certificate.doc.salutation} <strong className="bold">{certificate.doc.name.name}</strong>, son/daughter of <strong className="bold">{certificate.doc.name.father_name}</strong> and <strong className="bold">{certificate.doc.name.mother_name}</strong>,
          has been a student of this institution for <strong className="bold">5 years</strong>. During this period, the student has shown <strong className="bold">EXCELLENT</strong>
          character and conduct. <strong className="bold">{certificate.doc.name.name}</strong> has been <strong className="bold">sincere</strong>, <strong className="bold">honest</strong>, and
          <strong className="bold">hardworking</strong> throughout the academic years.
        </Typography>

        <Typography variant="body1" className={classes.body}>
          The student has exhibited <strong className="bold">exemplary behavior</strong> towards teachers and peers.
          <b className="bold">{certificate.doc.name.name}</b> has actively participated in <strong className="bold">all school activities</strong>
          and has shown <strong className="bold">leadership qualities</strong>.
          The student has always adhered to the <strong className="bold">rules and regulations</strong> of the institution
          and maintained <strong className="bold">discipline</strong> at all times.
        </Typography>

        <Typography variant="body1" className={classes.body}>
          We wish <strong className="bold">{certificate.doc.name.name}</strong> all the best for <strong className="bold">future endeavors</strong>.
        </Typography>
