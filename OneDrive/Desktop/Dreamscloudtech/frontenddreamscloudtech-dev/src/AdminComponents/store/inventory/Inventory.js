...
function Inventory() {
  ...
  return (
    <div>
      ...
      <div className="mb-3 d-flex justify-content-between content__container" style={{ backgroundColor: "#EEF7FF" }}>
        <button onClick={() => setopenAdd(true)} className="btn blue__btn">
          <AddIcon /> Add Item
        </button>
        <form action="">
          <input style={{ backgroundColor: "white" }} className="form-control" type="text" placeholder="Search..." />
        </form>
      </div>
      <Table
        data={inventory}
