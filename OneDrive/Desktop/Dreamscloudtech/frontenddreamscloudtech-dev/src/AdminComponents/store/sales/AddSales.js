...
//           </div>
//         </div>
//         <table className="table table-borderless" style={{ background: "#EEF7FF" }}>
//           <thead className="" style={{ background: "#1e9fef", color: "white" }}>
//             <tr>
...
//             <tr>
//               <button onClick={handleAddItem} className="btn lred__btn ml-3 mt-4">
//                 + Add another item
//               </button>
//             </tr>
//             <tr>
...
export default function CustomizedDialogs({
  ...
  useEffect(() => {
    if (selectedClass) {
      axios.get(`/students/class/${selectedClass}`).then((res) => {
        if (res.data.success) {
  ...
  return (
    ...
    >
      ...
      <form action="" className="mt-3 px-5">
        <div className="row">
          ...
          <div className="col-sm-4 mb-3">
            ...
            >
              ...
              {classesList?.length > 0 ? (
                classesList.slice().reverse().map((cls) => (
          ...
          <div className="col-sm-4 mb-3">
            ...
            >
              ...
              {students.length > 0 ? (
                students.map((std) => (
                  <option key={std._id} value={std.userID}>
        ...
        {/* Items Table */}
        <table className="table table-borderless" style={{ background: "#EEF7FF" }}>
          <thead style={{ background: "#1e9fef", color: "white" }}>
            <tr>
              <th colSpan={3}>Item Details</th>
              <th scope="col">Quantity</th>
              <th scope="col">Rate</th>
          ...
          <tbody>
            {buyitems?.map((e, i) => (
              <tr key={i}>
                <th colSpan={3}>
                  <textarea className="form-control" name="item" rows="2" value={e.name}></textarea>
                  <select
                    defaultValue="item"
                    onChange={(a) => handleSetitem(a.target.value, i)}
                    name="item"
                ...
                <th scope="col">
                  <input name="rate" value={e.rate} className="form-control" type="number" />
                </th>
                <th scope="col">
                  <input
                    name="discount"
                ...
                <th scope="col">
                  <input name="amount" className="form-control" value={e.amount} type="number" />
                </th>
              </tr>
            ))}
            ...
            <tr>
              ...
              <th colSpan={2}>
                <div className="d-flex justify-content-between">
                  <span>Balance</span>
                  <span>{(totalprice - amount).toFixed(2)}</span>
                </div>
              </th>
            </tr>
          </tbody>
