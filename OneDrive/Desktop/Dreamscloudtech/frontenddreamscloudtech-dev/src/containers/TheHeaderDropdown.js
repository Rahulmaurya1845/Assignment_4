        ...
        <CDropdown inNav className="c-header-nav-items ml-2 mr-5" direction="down">
            <CDropdownToggle className="c-header-nav-link" caret={false}>
                <div className="user__avatar ">
                    ...
                    <h5>
                        {" "}
                        <strong style={{ color: "#000", fontWeight: 500, fontFamily: "Poppins" }}>
                            {getCapitalize(user?.name)} {getIntial(user?.middleName || "")}{" "}
                            {getCapitalize(
                                user?.lastName === "undefined" ? "" : user?.lastName
                            )}
                        </strong>{" "}
                        <br /> <span className="roleText" style={{ color: "#000", fontWeight: "400 !important", fontFamily: "Poppins" }}>{user?.role}</span>
                    </h5>
